...
def run_test_integers():
    ...
    # Test 2:
    expected = [6, 10, 14, 10, 1, 3, 4, 4, 30, -11]
    answer = integers([(6, 'yes', 10),
                       ('snake', 14, 10),
                       [1, 'dog', 3, 4],
                       'cat',
                       [],
...
def run_test_big_letters():
    ...
    # Test 2:
    expected = 'ILKPACHCHAPSSEECOPDOO'
    answer = big_letters([(43, 3, 10),  # not a string
                          'I LiKe PizzA?',  # ILKPA
                          (6, 'Ok what is ThiSSS?', 3),  # not a string
                          [],  # not a string
                          ['oops'],  # not a string
                          'CHeck',  # CH
                          ['OOPS'],  # not a string
